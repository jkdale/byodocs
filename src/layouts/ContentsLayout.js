...
function TableOfContents({ tableOfContents, currentSection }) {
  ...
  return (
    <>
      <h5 className="text-gray-100 font-semibold mb-4 text-md leading-6">On this page</h5>
            ...
            <li>
              <a
                ...
                className={clsx(
                  ...
                  isActive(section) ? 'font-medium text-orange-500' : 'hover:text-gray-100'
                )}
              >
                {section.title}
              </a>
              ...
              <li className="ml-4" key={subsection.slug}>
                <a
                  ...
                  className={clsx(
                    ...
                    isActive(subsection) ? 'text-orange-500' : 'hover:text-gray-100'
                  )}
                >
                  <svg
                    width="3"
                    height="24"
                    viewBox="0 -9 3 24"
                    className="mr-2 text-gray-400 overflow-visible group-hover:text-gray-100"
                  >
                    <path
                      d="M0 0L3 3L0 6"
                      fill="none"
  ...
  return (
    <div className="max-w-3xl mx-auto pt-10 xl:max-w-none xl:ml-0 xl:mr-[15.5rem] xl:pr-16">
      <PageHeader
        ...
        badge={{ key: 'BYODocs version', value: meta.status }}
        section={section}
      />
      <ContentsContext.Provider value={{ registerHeading, unregisterHeading }}>
        {classes ? (
          ...
          <div id="content" className="relative z-20 prose text-lg text-gray-400 mt-8">
            <MDXProvider components={{ Heading }}>{children}</MDXProvider>
          </div>
        )}
      </ContentsContext.Provider>
      ...
      <Footer previous={prev} next={next}>
        <Link
          href={`https://github.com/0xdevelopereth/byodocs/edit/main/src/pages${router.pathname}.mdx`}
        >
