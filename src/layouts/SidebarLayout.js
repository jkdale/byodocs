      ...
      <Link href={isPublished ? href : fallbackHref}>
        <a
          className={clsx('block border-l pl-4 -ml-px', {
            'text-orange-500 border-current font-semibold': isActive,
            'border-transparent hover:border-orange-400': !isActive,
            'text-gray-400 border-orange-900 hover:text-gray-100': !isActive && isPublished,
          ...
          Object.keys(nav)
            .map((category) => {
              ...
              return (
                <li
                  key={category}
                  className="first-of-type:mt-0 first-of-type:lg:mt-0 mt-12 lg:mt-8"
                >
                  <h5 className={clsx('mb-8 lg:mb-3 font-semibold text-gray-200')}>{category}</h5>
                  <ul className="space-y-6 lg:space-y-2 border-l border-orange-900">
        ...
        icon={
          <>
            ...
            <path
              ...
              className="fill-orange-50 group-hover:fill-orange-100"
            />
          </>
        }
      >
        ...
        icon={
          <>
            ...
            <path
              ...
              className="fill-orange-200 group-hover:fill-orange-300"
            />
            <path
    ...
    <SidebarContext.Provider value={{ nav, navIsOpen, setNavIsOpen }}>
      <Wrapper allowOverflow={allowOverflow}>
        <div className="max-w-8xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="hidden lg:block fixed z-20 inset-0 top-[3.8125rem] left-[max(0px,calc(50%-45rem))] right-auto w-[19.5rem] py-10 px-8 overflow-y-auto scrollbar-none">
      ...
      >
        ...
        <div className="relative bg-space-900 w-80 max-w-[calc(100%-3rem)] p-6">
          <button
            type="button"
