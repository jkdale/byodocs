  ...
  return (
    <Component
      className={clsx('group flex whitespace-pre-wrap', className, {
        '-ml-4 pl-4': !hidden,
        'mb-2 text-sm leading-6 text-orange-500 font-semibold tracking-normal':
          level === 2 && nextElement?.type === 'heading' && nextElement?.depth === 3,
        'text-gray-100': level === 3,
      })}
      id={id}
      ref={ref}
    ...
    >
      {!hidden && (
        ...
        >
          &#8203;
          <div className="w-6 h-6 text-gray-400 ring-1 ring-gray-900/5 rounded-md shadow-sm flex items-center justify-center hover:ring-gray-900/10 hover:shadow hover:text-gray-100">
