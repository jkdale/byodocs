...
export function Footer({ children, previous, next }) {
  return (
    <footer className={clsx('text-sm leading-6', previous || next ? 'mt-12' : 'mt-16')}>
        ...
        <div className="mb-10 text-gray-700 font-semibold flex items-center">
          {previous && (
            <Link href={previous.href}>
              <a className="group flex items-center text-orange-500 hover:text-orange-600">
                <svg
                  viewBox="0 0 3 6"
                  className="mr-3 w-auto h-1.5 overflow-visible text-orange-500 group-hover:text-orange-600"
                >
                  <path
                    d="M3 0L0 3L3 6"
                    fill="none"
          ...
          {next && (
            <Link href={next.href}>
              <a className="group ml-auto flex items-center text-orange-500 hover:text-orange-600">
                {next.shortTitle || next.title}
                <svg
                  viewBox="0 0 3 6"
                  className="ml-3 w-auto h-1.5 text-orange-500 overflow-visible group-hover:text-orange-600"
                >
                  <path
                    d="M0 0L3 3L0 6"
                    fill="none"
      ...
      <div className="pt-10 pb-28 border-t border-gray-500/30 sm:flex justify-between text-gray-400">
        ...
        {children ? (
          ...
          <div className="flex space-x-10 text-gray-400">
            <a href="https://github.com/0xdevelopereth/byodocs" className="hover:text-gray-500">
            ...
            <a href="/discord" className="text-gray-400 hover:text-gray-100">
