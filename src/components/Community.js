export function Community() {
  return (
    <ul className="grid sm:grid-cols-2 gap-6 xl:gap-8">
      <li>
        <a
          href="https://github.com/0xdevelopereth/byodocs/discussions"
        ...
        >
          ...
          <div className="flex-auto">
            ...
            <p>Connect with members of the BYODocs community.</p>
          </div>
        </a>
      </li>
      <li>
        <a href="https://discord.gg/dbMUkR8dY2" className="flex items-start space-x-4">
          ...
          <div className="flex-auto">
            ...
            <p>Join our Discord group to chat with other BYOPill holders.</p>
          </div>
        </a>
      </li>
      <li>
        <a href="https://twitter.com/BYOPills" className="flex items-start space-x-4">
          ...
          <div className="flex-auto">
            ...
            <p>Follow the BYOPills Twitter account for news and updates.</p>
          </div>
        </a>
      </li>
      <li>
        <a href="/" className="flex items-start space-x-4">
          ...
          <div className="flex-auto">
            ...
            <p>Watch videos from BYOPills.</p>
          </div>
        </a>
      </li>
    </ul>
