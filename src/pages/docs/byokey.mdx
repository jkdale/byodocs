...
Check if your pill has been used on [https://knowyourtryp.com/](https://knowyourtryp.com/) by entering your pill ID in the search input field and look for "Apostle not yet claimed". If this is the case then your BYOPill is eligible for claiming an Apostle with a BYOKey.
