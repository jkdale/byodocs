...
<Player src="byokey.mp4" noSpacing className="float-left w-full md:w-1/2" />
...
*Note: [Apostles](/docs/apostles) consist of [four tiers](/docs/apostles#tiers) Lastly, keep in mind based on the limited supply of BYOKey's on the marketplace, it's strongly encouraged to look deeper into Apostles and seek out a rare BYOPill (Unclaimed) to increase your luck. Safe Travels Pillager!